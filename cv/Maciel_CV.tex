...
\begin{center}
  ...
  % \,\textbullet\, \href{https://YOUR-SITE-URL}{YOUR-SITE-URL}  % <- uncomment once the website is live
\end{center}
\vspace{2pt}
\hrule height 0.8pt
...
\begin{pubs}
  ...
  \item ``Made in Brazil: Job Creation and Firm Performance Under a Local Content Requirement''
        (with Erik Katovich). Funded by a
...
\subline{Spatial Econometrics\hfill 2026}
\subline{Economics of Climate Change\hfill 2025}
